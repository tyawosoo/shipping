...
# -------------------------
capacity_table = {
    "EV-6":   {"1+2": 36,  "1": 45,  "2": 36},
    "EV-14":  {"1+2": 80,  "1": 80,  "2": 80},
    "EV-32":  {"1+2":200, "1": 210, "2": 200},
    "EV-60":  {"1+2": 400, "1": 420, "2": 405},
    "EV-96":  {"1+2": 600, "1": 620, "2": 600},
    "EV-128": {"1+2": 680, "1": 700, "2": 680},
}
...
if st.button("计算最优方案"):
    ...
    for p in all_plans[:5]:  # 显示前 5 个最优方案
